  ...
  return (
    <div>
      <div className="top">
       ...
       <Link to="/Intro"><a href="default.asp">Home</a></Link>
        <a href="news.asp">My Bookings</a>
        <Link to="/Home"><a href="default.asp">Book Hall</a></Link>
        <Link to="/Gallery"><a href="default.asp">Gallery</a></Link>
        <a href="contact.asp">Contact</a>
        <a href="about.asp">About</a>
        <Link to="/"><a href="default.asp">Sign Out</a></Link>
      </div>
       </div>
    ...
    <div className='party1'>
     ...
     <div className='party12'>
         ...
         <h3>
            ...
            Looking for a place to conduct birthday parties <br></br>
            Then the best option would be this.<br></br>
            <br></br>
           <Link to="/Bookhall"><button>Book</button></Link>
         </h3>
         </center>
    ...
    <div className='party2'>
     ...
     <center><h1>Hall 2</h1>    
         <h3>
            ...
            Airconditioner: Yes<br></br>
            A perfect place set for family gathering or<br></br> a friends farewell party.
            <br></br><br></br>
            <Link to="/Bookhall"><button>Book</button></Link>
         </h3>
         </center>
    ...
    <div className='party31'>
     <center><h1>Hall 3</h1>    
         <h3>
            Seating Capacity: 1500<br></br><br></br>
            Airconditioner: Yes<br></br>
            A marrige or public gathering,then the perfect option<br></br>
         is this hall seating capacity alone 1500
            <br></br><br></br>
            <Link to="/Bookhall"><button>Book</button></Link>
         </h3>
         </center>
